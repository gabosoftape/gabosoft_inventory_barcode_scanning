odoo.define('poi_inteligent_stock', function(require){
"use strict";
  /*
    var ActionpadWidget = require('stock.screens').ActionpadWidget;
    ...
    var InventoryStockPopupWidget = PopupWidget.extend({
        template: 'IntelStockPopupWidget',
    ...
    gui.define_popup({name:'InventoryAuto', widget: InventoryStockPopupWidget});
